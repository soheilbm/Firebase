...
1. Confirm the build is [passing in travis](https://travis-ci.org/soheilbm/Firebase)
...
2. Push a release commit
   ...
   2. Rename the old Master section like:
          ## [1.0.5](https://github.com/soheilbm/Firebase/releases/tag/1.0.5)
